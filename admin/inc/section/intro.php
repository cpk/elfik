...
<section>
    	...
    	<div id="stats">
            <div id="chart_div">
                ...
                try {
                    ...
                    $oAnalytics->useCache();
                    $oAnalytics->setProfileByName("chicfashion.sk");
        ...
        <tr class="odd">
         ...
         <tr>
            ...
            <td class="r"><?php $arr = $conn->simpleQuery("SELECT count(*) FROM `user` WHERE `id_user_type`!=4");  echo $arr[0]["count(*)"] - 1; ?></td> 
        </tr>
        <tr class="odd">
        	<td class="l">Z toho s prístupom do administrácie:</td>
            <td class="r"><?php $arr = $conn->simpleQuery("SELECT count(*) FROM `user` WHERE `id_user_type`>1 AND `id_user_type`!=4");  echo $arr[0]["count(*)"] - 1; ?></td>
        </tr>
         <tr>
