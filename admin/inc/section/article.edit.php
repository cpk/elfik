...
<div class="left">
        ...
        <strong><a href="./index.php?p=article&amp;aid=0" class="root"> www.<?php echo $_SERVER["SERVER_NAME"]; ?> </a></strong>
        <ul id="tree">
    ...
    <div class="cbox">
        ...
        <div class="cbox">
            ...
            <form name="article">
                ...
                <div class="i">
                	<label>Typ: </label><select class="w200" name="type"><?php echo getOptions( $conn, "article_type", "name",  0); ?></select>
                </div>
